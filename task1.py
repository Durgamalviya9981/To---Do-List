...
if __name__ == "__main__":
  guiWindow = tk.Tk()
  guiWindow.title("To-DO List Manager - Durga Malviya")
  guiWindow. geometry("500x450+750+250")
  guiWindow.resizable(0, 0)
  guiWindow.configure(bg = "#FAEBD7")

  the_connection = sql.connect('list0fTasks.db')
  ...
  function_frame = tk.Frame(guiWindow, bg = "dark orange")
